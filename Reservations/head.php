...
<head>
	...
	<title>One Love Restaurant</title>
	<meta charset="utf-8">
...
<body>
	<nav class="navbar navbar-expand-md navbar-light fixed-top">
		<div class="container">
			<a class="navbar-band" href="index1.php">
				<strong><font color="brown"><em>Crazy For Coffee</em></font></strong></a>
				...
				<div class="collapse navbar-collapse" id="navi">
                    ...
                    //set navigation bar when login and admin tasks
                        if($_SESSION['role']==2)
                        {
                        	echo '<li class="nav-item">
                    ...
                    <?php
                    //log out button of user login
                    if(isset($_SESSION['user_id'])) 
                    {
                    	echo '<form class="navbar-form navbar-right" action="connection/logout.con.php" method="post">
		...
		<div class="modal fade" id="myModal_login">
			<div class="modal-dialog">
				<div class="modal-content">
                    ...
                    {
                    	echo '<h5 class="text-danger text-center">Please fill empty fields, Please try again!</h5>';
                    }
						...
						<div class="signin-form">
							<form action="connection/login.con.php" method="post">
								...
								<div class="form-group">
									<input type="text" name="mailuid" class="form-control" placeholder="Username Or Email" required="required">
								</div>
					...
					<div class="modal-body">
						...
						if(isset($_GET['error']))
						{
							echo '<script>
                             ...
                             {
                             	echo '<h5 class="bg-danger text-center">Please fill empty fields, Please try again!</h5>';
                             }
                             ...
                             {
                             	echo '<h5 class="bg-danger text-center">Password does not match, Please try again!</h5>';
                             }
							...
							//success model
						{
                            ...
                            {
                            	echo '<h5 class="bg-success text-center">Successfully Sign Up!!! Please Log in!</h5>';
                            }
						}
						echo '<br>';
						 ?>
						 ...
						 <div class="signup-form">
						 	<form action="connection/signup.con.php" method="post">
