...
if(isset($_SESSION['user_id']))
{
	...
	if($role == 1)
	{
		$sql = "SELECT * FROM reservations WHERE user_fk = $user";
    		...
    		while ($row = $result->fetch_assoc()) 
    		{
    			...
    			<tbody>
                    ...
                    <input name='reserv_id' type='hidden' value=".$row["reserv_id"].">
                      <th scope='row'>".$row["f_name"]." ".$row["l_name"]."
                      </th>
                      ...
                      <td class='table-danger'><button type='submit' name='delete-submit' class='btn btn-danger btn-sm'>Cancel</button>
                      </td>
                    </form>
                    </tr>
              	</tbody>
