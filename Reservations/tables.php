...
<div class="container">
	...
	<div class="col-md-6 offset-md-3">
				...
				if(isset($_GET['tables']))
					{
						...
						{
							echo '<h5 class="bg-success text-center">Tables was successfully updated</h5>';
						}	
					}

					echo '
					<div class="signup-form">
        			<form action="connection/tables.con.php" method="post">
            		 ...
            		 <div class="form-group">
            		 <button type="submit" name="tables" class="btn btn-dark btn-lg btn-block">Update Tables</button>
            		 </div>
            		 </form>
            		 <br><br>
            		 </div>
		...
		{
			echo '<p class="text-center"><br>You are have no permissions!<br><br></p>';
		}
